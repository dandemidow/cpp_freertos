...
void *__emutls_get_address (void *o) {
	...
	int const index {obj->loc.offset - 1};
...
int other_safe_func(int t) {
	thread_local OtherInfo common {};
	common.x += t;
	common.y += t;
	common.z += t;
...
#endif
#ifdef _GTHREAD_USE_MUTEX_TIMEDLOCK
#warning "GTHREAD_USE_MUTEX_TIMEDLOCK"
#endif
